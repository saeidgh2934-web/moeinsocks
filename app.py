...
st.subheader("۱. آپلود عکس مرجع (ترجیحاً بدون تا / صاف جهت تشخیص دقیق ارتفاع)")
uploaded_file = st.file_uploader("انتخاب تصویر مرجع محصول", type=["jpg", "jpeg", "png"])
